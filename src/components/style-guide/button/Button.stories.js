...
const Template = (args, { argTypes }) => ({
  ...
  template: `
    <v-container fluid>
      ...
      <v-row>
        <v-col>
          <dx-button color="primary" small v-bind="$props"> {{label}} </dx-button>
          <dx-button color="primary" v-bind="$props"> {{label}}  </dx-button>
          ...
          <dx-button color="primary" disabled v-bind="$props"> {{label}} </dx-button>
      ...
      <v-row>
        <v-col>
          <dx-button class="primary--text" color="secondary" v-bind="$props"> {{label}}  </dx-button>
          ...
          <dx-button class="primary--text" color="secondary" disabled v-bind="$props"> {{label}}  </dx-button>
        </v-col>
      </v-row>
      ...
      <v-row>
        <v-col>
          <dx-button color="neutral"  v-bind="$props"> {{label}}  </dx-button>
          ...
          <dx-button color="neutral"  disabled v-bind="$props"> {{label}} </dx-button>
        </v-col>
      </v-row>
      ...
      <v-row>
        <v-col>
          <dx-button color="success" v-bind="$props"> {{label}} </dx-button>
          ...
          <dx-button color="success" disabled v-bind="$props"> {{label}} </dx-button>
      ...
      <v-row>
        <v-col>
          <dx-button color="error" v-bind="$props"> {{label}}  </dx-button>
          ...
          <dx-button color="error" disabled v-bind="$props"> {{label}}  </dx-button>
      ...
      <v-row>
        <v-col>
          <dx-button color="warning" v-bind="$props"> {{label}}  </dx-button>
          ...
          <dx-button color="warning"  disabled v-bind="$props"> {{label}}  </dx-button>
      ...
      <v-row>
        <v-col>
          <dx-button color="dark" v-bind="$props"> {{label}}  </dx-button>
          ...
          <dx-button color="dark" disabled v-bind="$props"> {{label}}  </dx-button>
