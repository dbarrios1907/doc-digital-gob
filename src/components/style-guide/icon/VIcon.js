import "vuetify/src/components/VIcon/VIcon.sass"; // Mixins
...
import Themeable from 'vuetify/lib/mixins/themeable'; // Util

import { convertToUnit, keys, getObjectValueByPath } from 'vuetify/lib/util/helpers'; // Types
